#Submitting a picklist and verifying the status is Open
...
def test_picklist_status_after_submitting_picklist__is_open():
    with sync_playwright() as p:
        ...
        print(status)
        assert status== "Open", f"Status {status} is not 'Open'"
        browser.close()
